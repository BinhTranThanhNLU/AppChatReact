...
import {
    Send, Smile, Phone, Video, Info, MoreHorizontal, ThumbsUp, Image as ImageIcon, Mic,
} from "lucide-react";
        ...
        <div className="main-chat">
            ...
            <div className="messages-area">
                {sortedMessages.map((msg, index) => (
                    <div key={index} className={`message-row ${msg.userId === currentUser ? "me" : "other"}`}>
                        ...
                        <div className="message-content">
                            <div className="message-bubble">
                                {msg.msgType === "image" ? (
                                    <img src={msg.content} alt="chat-img" style={{ maxWidth: "220px", borderRadius: "12px" }} />
                                ) : msg.content}
                            </div>
                            <div style={{ fontSize: "10px", color: "#aaa", textAlign: msg.userId === currentUser ? "right" : "left" }}>
            ...
            <div className="chat-footer">
                ...
                <div className="input-wrapper">
                    <input className="chat-input" placeholder="Aa" value={inputMsg} onChange={(e) => setInputMsg(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleSend()} />
