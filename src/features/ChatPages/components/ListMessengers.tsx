...
const ListMessenger: React.FC<ListMessengerProps> = ({
    ...
    const handleSearch = () => {
        ...
        // Sử dụng API CHECK_USER_EXIST để kiểm tra user có thực sự tồn tại trên hệ thống không
        sendSocket({
            action: "onchat",
            data: {
        ...
        // Bạn cũng có thể gọi CHECK_USER_ONLINE nếu muốn biết trạng thái xanh/xám ngay lập tức
        /*
        sendSocket({
          action: "onchat",
          data: { event: "CHECK_USER_ONLINE", data: { user: value } }
        });
        */
            ...
            <div className="sidebar-header">
                ...
                <div className="search-container" style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                    <div style={{flex: 1, position: 'relative', display: 'flex', alignItems: 'center'}}>
                        <Search className="search-icon" size={18} style={{position: 'absolute', left: '10px'}}/>
                        <input
                            type="text"
